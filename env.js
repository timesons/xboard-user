...
window.settings = {
  // 站点名称
  title: (window.location.host.search('404') != -1) ? "隐身机场" : ((window.location.host.search('tizi001') != -1) ? "梯子001" : ((window.location.host.search('tizi100') != -1)) ? "梯子100" : ((window.location.host.search('fq100') != -1)) ? "翻墙100" : "狗急跳墙"),
  // 站点描述
